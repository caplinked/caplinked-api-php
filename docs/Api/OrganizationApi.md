...
$api_instance = new Caplinked\Api\OrganizationApi();
...
# **getOrganization**
> \Caplinked\Model\Organization getOrganization()
...
[**\Caplinked\Model\Organization**](../Model/Organization.md)
...
> \Caplinked\Model\User getOrganizationMemberships()
...
> \Caplinked\Model\OrganizationMembership postOrganizationMemberships($user_id)
...
[**\Caplinked\Model\OrganizationMembership**](../Model/OrganizationMembership.md)
...
# **putOrganization**
> \Caplinked\Model\Organization putOrganization($name, $description, $location, $billing_email, $url)
...
> \Caplinked\Model\SupportInformation putOrganizationSupportInformation($phone_number, $email, $website)
...
[**\Caplinked\Model\SupportInformation**](../Model/SupportInformation.md)
