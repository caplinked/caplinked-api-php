...
class ApiClient
{
     ...
     */
    public function __construct(\Caplinked\Configuration $config = null)
    {
        if ($config === null) {
     ...
     *
     * @throws \Caplinked\ApiException on a non 2xx response
     * @return mixed
     */
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType = null, $endpointPath = null)
    {
        ...
        // sign Caplinked request
        $headerParams['x-api-key'] = $this->config->getApiKey('cl-api-key');
        $headerParams['x-api-user-token'] = $this->config->getApiKey('cl-api-user-token');
        $headerParams['x-api-exp-date'] = strtotime('+10 minutes');
        $sigString = (string) $headerParams['x-api-key'] . (string) $headerParams['x-api-user-token'] . (string) $headerParams['x-api-exp-date'];
        ...
        if ($postData and in_array('Content-Type: application/x-www-form-urlencoded', $headers, true)) {
            ...
            $postData = json_encode(\Caplinked\ObjectSerializer::sanitizeForSerialization($postData));
        }
